  ...
  return (
    <section id="experience" className="snap-center">
      ...
      >
        ...
        <div className="w-full h-[75%] flex space-x-1 overflow-x-scroll snap-x snap-mandatory scrollbar-track-gray-400/20 scrollbar-thumb-cyan-500 scrollbar-thin max-w-5xl mx-auto">
